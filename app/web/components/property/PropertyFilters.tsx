...
export default function PropertyFilters() {
  ...
  // Debounced search on user typing query
  useEffect(() => {
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-4 rounded-2xl border transition-all font-bold ${isFilterOpen
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="flex bg-gray-50 rounded-xl p-1 border border-gray-100">
                {['all', 'Rent', 'Sell'].map((t) => (
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${listingType === t ? 'bg-white text-teal-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                  >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-2.5 rounded-xl border transition-all font-bold ${isVerified
