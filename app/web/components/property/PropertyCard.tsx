...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300 flex flex-col h-full group relative">
      <Link href={`/properties/${property.id}`} className="flex flex-col h-full">
        ...
        <div className="p-5 flex flex-col flex-1">
          <div className="flex justify-between items-start mb-2">
            <h3 className="text-xl font-bold text-gray-800 line-clamp-1 group-hover:text-[#00579e] transition-colors">{property.property_type}</h3>
          ...
          {/* View Details Push Button Indicator */}
          <div className="mt-auto">
            <div className="block w-full text-center bg-gray-50 group-hover:bg-[#00b48f] group-hover:text-white text-gray-700 group-hover:border-[#00b48f] border border-gray-200 py-3 rounded-lg font-semibold transition-colors">
              View Details
            </div>
          </div>
        </div>
