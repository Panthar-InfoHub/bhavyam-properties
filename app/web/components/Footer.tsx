  ...
  return (
    <footer className="bg-[#0f2336] text-gray-300 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex gap-3 items-center">
                <a 
                  href={`https://wa.me/919451567034?text=${encodeURIComponent('I want help related to properties')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-[#25D366] hover:text-[#20bd5c] transition-colors font-semibold"
                >
      ...
      <button 
        ...
        className="fixed bottom-6 left-6 p-3 bg-[#00ecbd] hover:bg-[#00b48f] text-white rounded-xl shadow-2xl transition-all z-50 flex items-center justify-center border-2 border-white hover:scale-110 active:scale-95"
      >
