...
export default function VerifyFAB() {
  ...
  return (
    <Link
      ...
      className="fixed top-[138px] md:top-[152px] right-4 md:right-[14px] z-[90] w-[125px] md:w-[145px] justify-center group flex items-center gap-1.5 bg-[#00ecbd] hover:bg-white text-[#112743] py-2 md:py-2.5 rounded-full font-black text-[9px] md:text-[10px] uppercase tracking-wider shadow-lg shadow-[#00ecbd]/20 border-2 border-white hover:scale-105 active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-top-10 duration-500 cursor-pointer focus:outline-none"
