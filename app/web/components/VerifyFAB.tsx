...
export default function VerifyFAB() {
  ...
  useEffect(() => {
    // Show on home page and about page
  ...
  return (
    <Link
      ...
      className="fixed bottom-8 right-8 z-[100] group flex items-center flex-row-reverse gap-3 animate-in fade-in slide-in-from-bottom-10 duration-500"
