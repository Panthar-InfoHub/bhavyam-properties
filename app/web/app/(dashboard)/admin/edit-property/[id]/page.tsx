        ...
        <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full border-2 border-gray-100 p-4 rounded-xl font-bold bg-gray-50/30 text-gray-800 placeholder-gray-400 outline-none focus:border-blue-500 transition-all cursor-text" 
                />
              </div>
              <div>
          ...
          <div className="pt-10 flex flex-col md:flex-row gap-4 border-t border-gray-100">
            <button 
              ...
              className="flex-1 bg-[#006B54] hover:bg-[#38FECE] hover:text-[#001229] text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:scale-95 transition-all duration-300 disabled:opacity-50 cursor-pointer"
            >
