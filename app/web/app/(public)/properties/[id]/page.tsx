...
export default function PropertyDetailsPage() {
  ...
  const factFeatures = [
    ...
    ...(property.area && property.area.toLowerCase() !== 'unspecified' ? [{ icon: '📏', label: property.area }] : []),
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 py-4 border-b border-gray-100">
               <div>
                 ...
                 <div className="flex items-center gap-3 text-sm text-gray-500 font-medium">
                   <span className="flex items-center gap-1.5"><svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/></svg> {property.area && property.area.toLowerCase() !== 'unspecified' ? `${property.area}, ` : ''}{property.city}</span>
